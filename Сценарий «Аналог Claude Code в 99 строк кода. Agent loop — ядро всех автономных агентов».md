...
Агент за 5 итераций агентского цикла смог ответить на вопрос. Отлично. 13я глава курса — это начальный Python, и вот в этой главе сейчас действительно 482 задания, и это число увеличивается, потому что я продолжаю их писать хахахах:) Если кто не в курсе, речь о «Хардкорной веб-разработке», моём авторском большом курсе, в котором мы глубоко копаем линукс, PostgreSQL, Python, Git, бэкенд, фронтенд, вопросы архитектуры и качества кода и так далее. Хотя многие, кто проходит курс, говорят, что самый большой его кайф в наших созвонах и чатике, что тоже интересное наблюдение. Кто готов работать и хочет прокачаться — приходите. Хардкор я вам обещаю:)

Так, ну а мы возвращаемся к чебупельке!

Давайте теперь его попробуем использовать для программирования:
