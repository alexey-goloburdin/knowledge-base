...
Брокер в Kafka это сервер, который принимает сообщения, сохраняет их и передаёт потребителям. Для масштабирования и надёжности кафка поднимается как правило сразу с несколькими серверами — например, с тремя серверами
