...
Ну а если нам надо увеличить степень параллелизма записи и чтения — мы можем увеличить количество разделов в топике и число брокеров, то есть серверо.
