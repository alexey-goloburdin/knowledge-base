...
- точно один раз — нам надо доставить строго 1 раз без потерь и дубликатов (есть мнение, что это на практике сложно выдержать в реальной системе, и что особо надеяться на это не стоит, и еще при таком способе доставки будут большие задержки, потому ).