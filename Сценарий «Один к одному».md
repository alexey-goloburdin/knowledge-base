...
create table employee (
	...
	some_bullshit_25 text, some_bullshit_25 text, some_bullshit_27 text,
...
-- Buffers: shared hit=353 read=85112
-- Execution Time: 155.298 ms
```
...
SELECT 
    ...
    'http://example.com/photo' || (random() * 10000)::int || '.jpg',
    -- Случайные заметки
    CASE WHEN random() < 0.5 THEN 'Hardworking' ELSE 'Punctual' END,
